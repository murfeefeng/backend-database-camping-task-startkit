...
SELECT "COURSE_BOOKING".user_id, COUNT(*) AS total FROM "COURSE_BOOKING" 
...
SELECT "CREDIT_PURCHASE".user_id,(
    (SELECT  SUM(purchased_credits) AS total FROM "CREDIT_PURCHASE"
        WHERE "CREDIT_PURCHASE".user_id = (SELECT id FROM "USER" WHERE email = 'wXlTq@hexschooltest.io')
...
FROM "COURSE_BOOKING"
WHERE "COURSE_BOOKING".created_at >= '2024-12-01 00:00:00' AND "COURSE_BOOKING".created_at <= '2024-12-30 23:59:59'
AND status != '課程已取消';
